...
echo '{"coc.preferences.formatOnSaveFiletypes": ["css", "html", "markdown", "json", "javascript", "typescript", "python", "typescriptreact"],"explorer.icon.enableNerdfont": true, "prettier.tabWidth": 4}' > ~/.config/nvim/coc-settings.json
